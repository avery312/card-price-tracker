...
if df.empty:
    ...
    # 💥 【核心修复】：将日期列转换为 datetime64[ns]，确保 st.data_editor 兼容性
    ...
    if display_df.empty:
        ...
        column_config_dict = {
            ...
            "date": st.column_config.DateColumn("录入时间", width=80, format="YYYY-MM-DD"), # DateColumn 完美兼容 datetime64
        ...
        # 移除 selection_mode="multi-row" 以兼容旧版本，启用复选框
